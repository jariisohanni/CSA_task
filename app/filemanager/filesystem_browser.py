...
import pathlib
import sys
sys.stderr.write('__________________________________________________________________\n')
sys.stderr.write('____ATENTION! This is NÄSA confidential Files System Browser!_____\n')
sys.stderr.write('----------------For authorized agents only------------------------\n')
sys.stderr.write('==================================================================\n')
text=input('Imput Secret Access Credentials (SAC):')
print(' @')
sys.stderr.write(' @#@#@\n')
print(' @#@#@#@#@#@')
sys.stderr.write(' @#@#@#@#@#@#@#@#@#@#@#@#@#@\n')
print(' @#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@')
sys.stderr.write('------YOUR ACCESS HAVE BEEN AUTHORISED!------\n')
print(' ')
print("Chose File option:")
print('------------------')
def Read():
